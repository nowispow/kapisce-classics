...
![Ladies of Longbourn making a formal morning call at Netherfield Hall, servants admitting them](./metadata/Pride and Prejudice/Chapter VI/scene_visit_netherfield.png)

![Ladies of Longbourn making a formal morning call at Netherfield Hall, servants admitting them](./metadata/Pride and Prejudice/Chapter VI/scene_formal_visit.png)
...
from the {/* metadata:quote_001:start */}
...
encouragement. In nine cases out of ten, {/* metadata:quote_002:start */}
...
![Elizabeth and Charlotte Lucas in conversation, Charlotte urging Jane to make the most of every half hour she can command Bingley's attention](./metadata/Pride and Prejudice/Chapter VI/scene_charlotte_counsel.png)

![Elizabeth and Charlotte Lucas in conversation, Charlotte urging Jane to make the most of every half hour she can command Bingley's attention](./metadata/Pride and Prejudice/Chapter VI/scene_friendship_dialogue.png)
...
uncommonly intelligent by the {/* metadata:quote_004:start */}
...
![Mr. Darcy watching Elizabeth from across a crowded room, his expression shifting from criticism to appreciation](./metadata/Pride and Prejudice/Chapter VI/scene_darcy_observation.png)

![Mr. Darcy watching Elizabeth from across a crowded room, his expression shifting from criticism to appreciation](./metadata/Pride and Prejudice/Chapter VI/scene_internal_conflict.png)
...
![Elizabeth Bennet seated at a pianoforte playing and singing, guests gathered in attentive listening](./metadata/Pride and Prejudice/Chapter VI/scene_elizabeth_performance.png)

![Elizabeth Bennet seated at a pianoforte playing and singing, guests gathered in attentive listening](./metadata/Pride and Prejudice/Chapter VI/scene_musical_evening.png)
...
![Mary Bennet at the piano playing a long concerto with earnest, self-important expression while listeners grow restless](./metadata/Pride and Prejudice/Chapter VI/scene_mary_performance.png)

![Mary Bennet at the piano playing a long concerto with earnest, self-important expression while listeners grow restless](./metadata/Pride and Prejudice/Chapter VI/scene_pedantic_display.png)
...
![Elizabeth drawing back her hand as Mr. Darcy requests the honour of her hand at Sir William Lucas's gathering](./metadata/Pride and Prejudice/Chapter VI/scene_refused_dance.png)

![Elizabeth drawing back her hand as Mr. Darcy requests the honour of her hand at Sir William Lucas's gathering](./metadata/Pride and Prejudice/Chapter VI/scene_dance_refusal.png)
...
imagination is very rapid; {/* metadata:quote_006:start */}
...
{/* metadata:quote_006:end */} I knew you would be wishing me joy.”

{/* metadata:image_007:start */}
![Miss Bingley questioning Mr. Darcy about his admiration for Elizabeth, her expression sharp with jealousy](./metadata/Pride and Prejudice/Chapter VI/scene_miss_bingley_interrogation.png)

![Miss Bingley questioning Mr. Darcy about his admiration for Elizabeth, her expression sharp with jealousy](./metadata/Pride and Prejudice/Chapter VI/scene_bingley_darcy_dialogue.png)
...
of course {/* metadata:quote_007:start */}
