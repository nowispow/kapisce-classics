...
description: "Follow the story in Chapter 47 of Jane Austen's Pride And Prejudice."
date: 2026-02-16
authors: ['jane-austen']
...
to marry her. {/* metadata:QT002:start */}
<Callout title="Memorable Quote" variant="note">Wickham will never marry a woman without some money. He cannot afford it.</Callout>
{/* metadata:QT002:end */} And what claims has Lydia, what attractions has she
...
nay, for a twelvemonth, {/* metadata:QT004:start */}
<Callout title="Memorable Quote" variant="note">She has been given up to nothing but amusement and vanity. She has been allowed to dispose of her time in the most idle and frivolous manner, and to adopt any opinions that came in her way.</Callout>
{/* metadata:QT004:end */}

{/* metadata:003:start */}
<Callout title="Analysis" variant="explanation">
Jane Austen uses this chapter to critique the education of young women through Elizabeth's candid assessment of Lydia's character. Lydia's 'susceptibility' is portrayed not as innate depravity but as the result of systemic neglect—her idle lifestyle, lack of serious instruction, and exposure to military society have collectively eroded her moral foundations. Elizabeth observes that 'for a twelvemonth, she has been given up to nothing but amusement and vanity,' indicting the entire household's indifference to her formation.
</Callout>
{/* metadata:003:end */}
...
Wickham really is. {/* metadata:QT003:start */}
<Callout title="Memorable Quote" variant="note">We both know that he has been profligate in every sense of the word; that he has neither integrity nor honour; that he is as false and deceitful as he is insinuating.</Callout>
{/* metadata:QT003:end */}
...
{/* metadata:002:start */}
<Callout title="Analysis" variant="explanation">
The contrast between Elizabeth's clear-eyed understanding of Wickham's profligate nature and the Gardiners' initial optimism highlights the tension between hope and realism in crisis. Elizabeth's inability to share Darcy's confidences creates a tragic irony where her newfound knowledge, gained too late, becomes a source of guilt rather than protection. She acknowledges directly: 'That she could be in any danger from the deception never entered my head.'
</Callout>
{/* metadata:002:end */}
...
{/* metadata:IMG001:start */}
![Elizabeth and the Gardiners in a carriage in deep conversation amidst rolling countryside](./metadata/pride-and-prejudice/chapter-47/scene-1a.png)

![Elizabeth and the Gardiners in a carriage in deep conversation amidst rolling countryside](./metadata/pride-and-prejudice/chapter-47/scene-1b.png)
{/* metadata:IMG001:end */}

emoved to Brighton, therefore, you had no reason, I
...
{/* metadata:IMG006:start */}
![The young Gardiners welcoming the carriage with innocent exuberance](./metadata/pride-and-prejudice/chapter-47/scene-6a.png)

![The young Gardiners welcoming the carriage with innocent exuberance](./metadata/pride-and-prejudice/chapter-47/scene-6b.png)
{/* metadata:IMG006:end */}
...
its repeated discussion, no other cou

{/* metadata:IMG002:start */}
![Elizabeth and Jane's emotional reunion in the vestibule of Longbourn](./metadata/pride-and-prejudice/chapter-47/scene-2a.png)

![Elizabeth and Jane's emotional reunion in the vestibule of Longbourn](./metadata/pride-and-prejudice/chapter-47/scene-2b.png)
{/* metadata:IMG002:end */}

ld detain them from it long, during
the whole of the journey. {/* metadata:QT001:start */}
<Callout title="Memorable Quote" variant="note">From Elizabeth's thoughts it was never absent. Fixed there by the keenest of all anguish, self-reproach, she could find no interval of ease or forgetfulness.</Callout>
{/* metadata:QT001:end */}

{/* metadata:001:start */}
<Callout title="Analysis" variant="explanation">
This chapter marks a pivotal turning point in the novel as Elizabeth confronts the devastating consequences of Lydia's elopement with Wickham. The narrative reveals Elizabeth's profound self-reproach for keeping silent about Wickham's true character, a silence she now recognizes as catastrophic. Her anguish is rendered with psychological precision: fixed by 'the keenest of all anguish, self-reproach, she could find no interval of ease or forgetfulness.'
</Callout>
{/* metadata:001:end */}
...
particularly begged him to do. He merely added, that he shoul

{/* metadata:004:start */}
<Callout title="Analysis" variant="explanation">
Mrs. Bennet's hysterical response to the crisis reveals the devastating consequences of her own indulgent parenting. Her immediate blame of everyone except herself, combined with her theatrical concerns about wedding clothes while her daughter's virtue hangs in the balance, exemplifies Austen's critique of mothers who prioritize social appearances over genuine moral responsibility. The narrator notes she received her family 'with tears and lamentations of regret,' blaming everybody but the person whose 'ill-judging indulgence' had principally caused the disaster.
</Callout>
{/* metadata:004:end */}
...
{/* metadata:IMG003:start */}
![Mrs. Bennet in her dressing room, in a state of nervous agitation, attended by the housekeeper](./metadata/pride-and-prejudice/chapter-47/scene-3a.png)

![Mrs. Bennet in her dressing room, in a state of nervous agitation, attended by the housekeeper](./metadata/pride-and-prejudice/chapter-47/scene-3b.png)
{/* metadata:IMG003:end */}

e worst, there is no occasion to look on it as certain.
...
{/* metadata:005:start */}
<Callout title="Analysis" variant="explanation">
Mary's sermonizing offers comic relief amid the tragedy while reinforcing the novel's thematic concern with performative morality. Her abstract 'moral extractions' about female virtue, delivered 'with a countenance of grave reflection' while her sister faces actual ruin, satirizes the detachment of book-learned piety from genuine compassion. The irony is sharpened by Elizabeth's response: she 'lifted up her eyes in amazement, but was too much oppressed to make any reply.'
</Callout>
{/* metadata:005:end */}

 such a seclusion from the family, they did not attempt to
oppose it; for they knew that she had not pruden

{/* metadata:IMG004:start */}
![Mary Bennet delivering her sermon on virtue at the dinner table](./metadata/pride-and-prejudice/chapter-47/scene-4a.png)

![Mary Bennet delivering her sermon on virtue at the dinner table](./metadata/pride-and-prejudice/chapter-47/scene-4b.png)
{/* metadata:IMG004:end */}

ce enough to hold her
...
“We acted with the best inte

{/* metadata:006:start */}
<Callout title="Analysis" variant="explanation">
Lydia's letter serves as a devastating document of youthful folly, revealing through its breezy tone and focus on trivialities—dancing engagements, dress repairs, 'good jokes'—the dangerous gap between her romantic fantasies and the gravity of her situation. The letter's anticipation of signing 'Lydia Wickham' underscores her naive assumption that marriage is certain. Elizabeth's response captures the double horror perfectly: the letter proves Lydia was not scheming, yet its levity makes the situation no less dire.
</Callout>
{/* metadata:006:end */}
...
{/* metadata:IMG005:start */}
![Elizabeth reading Lydia's thoughtless letter with growing horror](./metadata/pride-and-prejudice/chapter-47/scene-5a.png)

![Elizabeth reading Lydia's thoughtless letter with growing horror](./metadata/pride-and-prejudice/chapter-47/scene-5b.png)
{/* metadata:IMG005:end */}

hen took it from her pocket-book, and gave it to Elizabeth. These
were the contents:--
...
finished it. {/* metadata:QT005:start */}
<Callout title="Memorable Quote" variant="note">Oh, thoughtless, thoughtless Lydia! What a letter is this, to be written at such a moment!</Callout>
{/* metadata:QT005:end */} But
...
very difficult. {/* metadata:QT006:start */}
<Callout title="Memorable Quote" variant="note">My mother was in hysterics; and though I endeavoured to give her every assistance in my power, I am afraid I did not do so much as I might have done.</Callout>
{/* metadata:

{/* metadata:007:start */}
<Callout title="Analysis" variant="explanation">
The chapter concludes with Mr. Bennet's desperate investigative efforts in London, emphasizing the humiliating exposure of private scandal to public inquiry. His search for hackney coach numbers and postilions transforms the family crisis into a sordid detective story, illustrating how elopement destroys not only virtue but also dignity. Jane recounts that he meant 'to find out the stand and number of the coach,' a detail that reduces a father's anguish to the mechanics of urban detection.
</Callout>
{/* metadata:007:end */}

QT006:end */} But the horror of what might possibly happen
almost took from me my faculties.”

“Your attendance upon her has been too much for you. You do not look
well. Oh that I had been with 

{/* metadata:IMG007:start */}
![Mr. Bennet's desperate inquiries at a coaching inn](./metadata/pride-and-prejudice/chapter-47/scene-7a.png)

![Mr. Bennet's desperate inquiries at a coaching inn](./metadata/pride-and-prejudice/chapter-47/scene-7b.png)
{/* metadata:IMG007:end */}

you! you have had every care and anxiety
upon yourself alone.”
...
{/* metadata:QT007:start */}
<Callout title="Memorable Quote" variant="note">She had better have stayed at home. Perhaps she meant well, but, under such a misfortune as this, one cannot see too little of one's neighbours.</Callout>
{/* metadata:QT007:end */} Assistance is impossible; condolence,
