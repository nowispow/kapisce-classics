...
![Mr. Collins's punctual arrival at Longbourn, the tall heavy-looking clergyman being received](./metadata/pride-and-prejudice/13/collins_arrival.png)

![Mr. Collins's punctual arrival at Longbourn, the tall heavy-looking clergyman being received](./metadata/pride-and-prejudice/13/collins_formal_greeting_study.png)
{/* metadata:img_005:end */}

 {/* metadata:quote_001:start */}
<Callout title="Memorable Quote" variant="note">I hope, my dear, that you have ordered a good dinner to-day, because I have reason to expect an addition to our family party.</Callout>
...
Mrs. Bennet’s eyes sparkled. {/* metadata:quote_002:start */}
<Callout title="Memorable Quote" variant="note">A gentleman and a stranger! It is Mr. Bingley, I am sure.</Callout>
{/* metadata:quote_002:end */} Why, Jane--you never dropped a word of this--you sly
...
to-day. Lydia, my love, ring the bell.

{/* metadata:img_001:start */}
![The Bennet family gathered at breakfast table, Mr. Bennet teasing his wife with news of a visitor](./metadata/pride-and-prejudice/13/breakfast_announcement_wide.png)

![The Bennet family gathered at breakfast table, Mr. Bennet teasing his wife with news of a visitor](./metadata/pride-and-prejudice/13/mrs_bennet_excited_portrait.png)
{/* metadata:img_001:end */}

 I must speak to Hill this
moment.”
...
![Imagined portrait of Lady Catherine de Bourgh as described in Collins's letter, embodiment of aristocratic patronage](./metadata/pride-and-prejudice/13/lady_catherine_portrait.png)

![Imagined portrait of Lady Catherine de Bourgh as described in Collins's letter, embodiment of aristocratic patronage](./metadata/pride-and-prejudice/13/collins_lady_catherine_allegory.png)
{/* metadata:img_003:end */}
 ...
 As a clergyman,
     ...
     olive branch. {/* metadata:quote_004:start */}
...
{/* metadata:quote_004:end */} If you should
...
![Mr. Bennet reading aloud the obsequious letter from his cousin Mr. Collins to the assembled family](./metadata/pride-and-prejudice/13/reading_letter_scene.png)

![Mr. Bennet reading aloud the obsequious letter from his cousin Mr. Collins to the assembled family](./metadata/pride-and-prejudice/13/collins_letter_closeup.png)
...
![Elizabeth Bennet contemplating Mr. Collins's letter with critical intelligence](./metadata/pride-and-prejudice/13/elizabeth_contemplating_letter.png)

![Elizabeth Bennet contemplating Mr. Collins's letter with critical intelligence](./metadata/pride-and-prejudice/13/elizabeth_mr_bennet_conspiracy.png)
...
{/* metadata:quote_007:end */} Bennet’s
heart, but for the mortifying supposition of his viewing it all as his
own future property.

{/* metadata:img_006:start */}
![Mr. Collins admiring the Longbourn dining room with proprietorial interest as the Bennet family watches](./metadata/pride-and-prejudice/13/collins_inspecting_dining_room.png)

![Mr. Collins admiring the Longbourn dining room with proprietorial interest as the Bennet family watches](./metadata/pride-and-prejudice/13/collins_proprietorial_gaze.png)
...
![The Bennet family at dinner with Mr. Collins giving awkward compliments about cookery and apologizing excessively](./metadata/pride-and-prejudice/13/dinner_with_collins.png)

![The Bennet family at dinner with Mr. Collins giving awkward compliments about cookery and apologizing excessively](./metadata/pride-and-prejudice/13/collins_apology_scene.png)
