...
{/* metadata:2:start */}
![a young woman with intelligent expression and slight smile, sitting in contemplation](./metadata/Pride and Prejudice/Chapter XXVI/img_2a_elizabeth_wit.png)

![a young woman with intelligent expression and slight smile, sitting in contemplation](./metadata/Pride and Prejudice/Chapter XXVI/img_2b_elizabeth_portrait.png)
{/* metadata:2:end */}
...
{/* metadata:1:start */}
![an interior scene with two women in period dress engaged in intimate conversation, one older and concerned, the other younger and thoughtful](./metadata/Pride and Prejudice/Chapter XXVI/img_1a_gardiner_warning.png)

![an interior scene with two women in period dress engaged in intimate conversation, one older and concerned, the other younger and thoughtful](./metadata/Pride and Prejudice/Chapter XXVI/img_1b_intimate_conference.png)
{/* metadata:1:end */}
...
{/* metadata:3:start */}
![two women descending a staircase together, one departing with mixed emotions](./metadata/Pride and Prejudice/Chapter XXVI/img_3a_farewell_stairs.png)

![two women descending a staircase together, one departing with mixed emotions](./metadata/Pride and Prejudice/Chapter XXVI/img_3b_farewell_embrace.png)
{/* metadata:3:end */}
...
{/* metadata:4:start */}
![a bride and groom departing from a church, surrounded by wedding guests](./metadata/Pride and Prejudice/Chapter XXVI/img_4a_wedding_departure.png)

![a bride and groom departing from a church, surrounded by wedding guests](./metadata/Pride and Prejudice/Chapter XXVI/img_4b_wedding_scene.png)
{/* metadata:4:end */}
...
{/* metadata:6:start */}
![two women in a formal drawing room, one visibly uncomfortable and making excuses to leave](./metadata/Pride and Prejudice/Chapter XXVI/img_6a_bingley_visit.png)

![two women in a formal drawing room, one visibly uncomfortable and making excuses to leave](./metadata/Pride and Prejudice/Chapter XXVI/img_6b_formal_encounter.png)
{/* metadata:6:end */}
...
{/* metadata:5:start */}
![a young woman reading a letter with visible sadness, seated in a London drawing room](./metadata/Pride and Prejudice/Chapter XXVI/img_5a_jane_reading.png)

![a young woman reading a letter with visible sadness, seated in a London drawing room](./metadata/Pride and Prejudice/Chapter XXVI/img_5b_jane_writing.png)
{/* metadata:5:end */}
...
{/* metadata:7:start */}
![a young woman in quiet contemplation, her expression showing philosophical acceptance](./metadata/Pride and Prejudice/Chapter XXVI/img_7a_elizabeth_reflection.png)

![a young woman in quiet contemplation, her expression showing philosophical acceptance](./metadata/Pride and Prejudice/Chapter XXVI/img_7b_contemplative_elizabeth.png)
{/* metadata:7:end */}
