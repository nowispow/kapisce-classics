...
{/* metadata:quote_001:end */} With what delighted pride she
...
it was lucky for her husband, who mig
...
![A proud mother in Regency era dress receiving congratulations](./metadata/pride-and-prejudice/chapter-61/scene-1b.png)
{/* metadata:image_001:end */}

ht not have relished domestic
...
<Callout title="Analysis" variant="explanation">
The transformation of Mr. Bennet's relationship with Elizabeth represents one of the novel's most touching character developments. His excessive visits to Pemberley, where he delights in surprising his daughter, reveal a depth of paternal affection that had been somewhat masked by his sardonic wit throughout the novel. Elizabeth has become the daughter he values above all others, and Pemberley has become his sanctuary away from Longbourn, drawing him there especially when he was least expected.
</Callout>
...
![A father warmly embracing his daughter in a grand estate](./metadata/pride-and-prejudice/chapter-61/scene-2b.png)
{/* metadata:image_002:end */}

Mr. Bennet missed his second daughter exceedingly; his affection for her drew him oftener from home than anything else could do.</Callout>
{/* metadata:quote_002:end */} He delighted in
going to Pemberley, especially when he was least expected.

Mr. Bingley and Jane remained at Netherfield only a twelvemonth. {/* metadata:quote_003:start */}
<Callout title="Memorable Quote" variant="note">So near a vicinity to her m
...
![Two sisters in elegant dress conversing in a pastoral Derbyshire landscape](./metadata/pride-and-prejudice/chapter-61/scene-3b.png)
{/* metadata:image_003:end */}

other and Meryton relations was not desirable even to his easy temper, or her affectionate heart.</Callout>
{/* metadata:quote_003:end */} The darling wish of his
...
known, {/* metadata:quote_004:start */}
<Callout title="Memorable Quote" variant="note">Her improvement was great
...
![A young woman reading in a refined drawing room with her elder sisters](./metadata/pride-and-prejudice/chapter-61/scene-4a.png)
...
. She was not of so ungovernable a temper as Lydia; and, removed from the influence of Lydia's example, she became, by proper attention and management, less irritable, less ignorant, and less insipid.</Callout>
{/* metadata:quote_004:end */} From the further disadvantage of Lydia’s
...
![A plain young woman playing pianoforte for her mother in a modest parlor](./metadata/pride-and-prejudice/chapter-61/scene-5b.png)
{/* metadata:image_005:end */}

ther would never consent to her going.
...
{/* metadata:quote_005:end */} Mary was obliged to mix more with the world, but
...
![A restless couple in modest lodgings with packing trunks](./metadata/pride-and-prejudice/chapter-61/scene-6b.png)
...
{/* metadata:quote_006:end */} Though Darcy could never
...
With the Gardiners they were always on the most intimate terms. {/* metadata:quote_007:start */}
...
![An aristocratic lady being received at a grand estate with dignified ceremony](./metadata/pride-and-prejudice/chapter-61/scene-7b.png)
