...
<Callout title="Memorable Quote" variant="note">It keeps h
...
im in good humour</Callout>
{/* metadata:quote_001:end */} said she, “and I am more obliged to you than I can express.”
...
bject was nothing less than to secure her
from any return of Mr. Collins’s addresses, by engaging them towards
herself. {/* metadata:quote_002:start */}
<Callout title="Memorable Quote" variant="note">Such was Miss Lucas's scheme; and appearances were so favourable</Callout>
...
or Charlotte had been tolerably encouraging,
...
![Charlotte Lucas watches from an upper window as Mr. Collins approaches Lucas Lodge on a country lane](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/charlotte_watching_window.png)

![Charlotte Lucas watches from an upper window as Mr. Collins approaches Lucas Lodge on a country lane](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/charlotte_planning_encounter.png)
{/* metadata:img_001:end */}

m an upper window as he walked towards the house, and
...
<Callout title="Memorable Quote" variant="note">In as short a time as Mr. Collins's long speeches would allow</Callout>
...
![Mr. Collins making his proposal to Charlotte Lucas in a drawing room at Lucas Lodge](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/collins_proposing.png)

![Mr. Collins making his proposal to Charlotte Lucas in a drawing room at Lucas Lodge](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/engagement_accepted.png)
{/* metadata:img_002:end */}

ote" variant="note">The stupidity with which he was favoured by nature must guard his courtship from any charm that could make a woman wish for its continuance</Callout>
{/* metadata:quote_004:end */} and Miss Lucas, who accepted him solely from the pure and
...
![Sir William and Lady Lucas receiving news of their daughter's engagement with expressions of calculated delight](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/lucas_parents_joy.png)

![Sir William and Lady Lucas receiving news of their daughter's engagement with expressions of calculated delight](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/lady_lucas_calculating.png)
{/* metadata:img_003:end */}

 before, how many years longer Mr. Bennet was likely to live; and
...
![Charlotte Lucas in a moment of private contemplation after accepting Mr. Collins's proposal](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/charlotte_reflection.png)

![Charlotte Lucas in a moment of private contemplation after accepting Mr. Collins's proposal](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/charlotte_mirror.png)
{/* metadata:img_004:end */}

{/* metadata:quote_005:start */}
<Callout title="Memorable Quote" variant="note">marriage had always been her object: it was the only honourable provision for well-educated young women of small fortune</Callout>
{/* metadata:quote_005:end */} and, however
...
![Mr. Bennet delivering his ironic warning to Mr. Collins about Lady Catherine's potential displeasure](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/bennet_warning.png)

![Mr. Bennet delivering his ironic warning to Mr. Collins about Lady Catherine's potential displeasure](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/bennet_amused.png)
...
![Charlotte Lucas privately informing Elizabeth Bennet of her engagement to Mr. Collins](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/elizabeth_shocked.png)

![Charlotte Lucas privately informing Elizabeth Bennet of her engagement to Mr. Collins](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/charlotte_telling_elizabeth.png)
{/* metadata:img_006:end */}

 away. Miss Lucas called soon after breakfast, and in a
...
satisfied with what I have done. {/* metadata:quote_006:start */}
<Callout title="Memorable Quote" variant="note">I am not romantic, you know. I never was</Callout>
{/* metadata:quote_006:end */} I ask only a comfortable home; and, considering Mr. Collins’s
...
most humiliating picture! {/* metadata:quote_007:start */}
...
![Elizabeth Bennet left alone to contemplate Charlotte's engagement and its implications for their friendship](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/elizabeth_reflecting.png)

![Elizabeth Bennet left alone to contemplate Charlotte's engagement and its implications for their friendship](./metadata/Pride And Prejudice/Chapter XXII/assets/chapter_22/elizabeth_contemplation.png)
