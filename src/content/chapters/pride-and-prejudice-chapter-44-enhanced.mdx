...
![A gentleman and lady in a curricle driving up a village street, viewed through an inn window by onlookers](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-1a.png)

![A gentleman and lady in a curricle driving up a village street, viewed through an inn window by onlookers](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-1b.png)
...
![Three figures meeting in a room, two young women and a gentleman, all displaying signs of embarrassment and shyness](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-2a.png)

![Three figures meeting in a room, two young women and a gentleman, all displaying signs of embarrassment and shyness](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-2b.png)
...
![A cheerful gentleman entering a room, displaying warmth and cordiality](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-3a.png)

![A cheerful gentleman entering a room, displaying warmth and cordiality](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-3b.png)
...
![An older couple observing a younger pair with perceptiveness and interest](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-4a.png)

![An older couple observing a younger pair with perceptiveness and interest](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-4b.png)
...
![A proud gentleman showing unusual civility and warmth toward his former social inferiors](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-5a.png)

![A proud gentleman showing unusual civility and warmth toward his former social inferiors](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-5b.png)
...
![A formal scene where a visiting party takes leave while issuing an invitation](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-6a.png)

![A formal scene where a visiting party takes leave while issuing an invitation](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-6b.png)
...
![A young woman lying awake in bed, illuminated by moonlight, deep in contemplation](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-7a.png)

![A young woman lying awake in bed, illuminated by moonlight, deep in contemplation](./metadata/Pride and Prejudice/Chapter XLIV (44)/scene-7b.png)
