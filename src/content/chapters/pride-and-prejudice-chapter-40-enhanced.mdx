...
<Callout title="Memorable Quote" variant="note">Elizabeth's impatience to acquaint Jane with what had happened could no longer be overcome.</Callout>
{/* metadata:quote-1:end */} and at length resolving to suppress every particular
in which her sister was concerned, and pr
...
![Two sisters in morning dresses sharing secrets in a sunlit drawing room](./metadata/pride-and-prejudice/chapter-40/scene-1a.png)

![Two sisters in morning dresses sharing secrets in a sunlit drawing room](./metadata/pride-and-prejudice/chapter-40/scene-1b.png)
{/* metadata:image-1:end */}

eparing her to be surprised,
she related to her the next morning the chief of the scene between Mr.
Darcy and herself.

{/* metadata:quote-2:start */}
<Callout title="Memorable Quote" variant="note">Miss Bennet's astonishment was soon lessened by the strong sisterly partiality which made any admiration of Elizabeth appear perfectly natural.</Callout>
{/* metadata:quote-2:end */} and all surprise was shortly lost in other feelings. She was
...
ought not to have appeared; but consider 
...
![Jane Bennet with gentle, concerned expression contemplating her sister's tale](./metadata/pride-and-prejudice/chapter-40/scene-2a.png)

![Jane Bennet with gentle, concerned expression contemplating her sister's tale](./metadata/pride-and-prejudice/chapter-40/scene-2b.png)
{/* metadata:image-2:end */}

how much it must increase his
disappointment.”
...
as they concerned George Wickham. What a stroke was this for poor {/* metadata:quote-3:start */}
<Callout title="Memorable Quote" variant="note">Jane, who would willingly have gone through the world without believing that so mu
...
![Jane receiving shocking news about human wickedness, her expression showing distress and disbelief](./metadata/pride-and-prejudice/chapter-40/scene-3a.png)

![Jane receiving shocking news about human wickedness, her expression showing distress and disbelief](./metadata/pride-and-prejudice/chapter-40/scene-3b.png)
{/* metadata:image-3:end */}

ch wickedness existed in the whole race of mankind as was here collected in one individual!</Callout>
{/* metadata:quote-3:end */} Nor was Darcy’s vindication, though
...
![Elizabeth with a knowing smile, her characteristic irony and humor returning](./metadata/pride-and-prejudice/chapter-40/scene-4a.png)

![Elizabeth with a knowing smile, her characteristic irony and humor returning](./metadata/pride-and-prejudice/chapter-40/scene-4b.png)
{/* metadata:image-4:end */}

never will be able to make both
of them good for anything. Take your choice, but you must be satisfied
with only one. {/* metadata:quote-4:start */}
...
{/* metadata:quote-4:end */} For my part, I am inclined to believe it all Mr.
...
to him, without any reason. {/* metadata:quote-5:start */}
...
{/* metadata:quote-5:end */} One may be continually
...
and vain, and nonsensical, as I knew I had! {/* metadata:quote-6:start */}
...
![A folded letter held contemplatively, symbolizing hidden knowledge and discretion](./metadata/pride-and-prejudice/chapter-40/scene-5a.png)

![A folded letter held contemplatively, symbolizing hidden knowledge and discretion](./metadata/pride-and-prejudice/chapter-40/scene-5b.png)
{/* metadata:image-5:end */}

r to undeceive people as to the rest of his
...
himself. {/* metadata:quote-7:start */}
...
![Jane alone in contemplation, her unrequited love for Bingley evident in her pensive demeanor](./metadata/pride-and-prejudice/chapter-40/scene-6a.png)

![Jane alone in contemplation, her unrequited love for Bingley evident in her pensive demeanor](./metadata/pride-and-prejudice/chapter-40/scene-6b.png)
...
cannot find out that Jane saw anything of him in London. We
...
![Mrs. Bennet making exaggerated gestures while speaking dramatically to Elizabeth](./metadata/pride-and-prejudice/chapter-40/scene-7a.png)

![Mrs. Bennet making exaggerated gestures while speaking dramatically to Elizabeth](./metadata/pride-and-prejudice/chapter-40/scene-7b.png)
