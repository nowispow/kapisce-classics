...
![The Bingley sisters showing indifference after Elizabeth leaves.](./metadata/pride-and-prejudice/chapter-8/scene-1-var-1.png)

![The Bingley sisters showing indifference after Elizabeth leaves.](./metadata/pride-and-prejudice/chapter-8/scene-1-var-2.png)
...
Elizabeth's 'enjoyment' of her dislike highlights her spirited, if somewhat prejudiced, character. She finds psychological comfort in her low opinion of the Bingley sisters, which contrasts with Bingley's genuine concern for Jane.
</Callout>
...
{/* metadata:image-unknown:start */}
![Caroline Bingley whispering to Mr. Darcy.](./metadata/pride-and-prejudice/chapter-8/scene-2-var-1.png)

![Caroline Bingley whispering to Mr. Darcy.](./metadata/pride-and-prejudice/chapter-8/scene-2-var-2.png)
{/* metadata:image-unknown:end */}
...
The Bingley sisters' critique of Elizabeth reveals more about their own social rigidity than Elizabeth's shortcomings. They define 'style' and 'taste' through a lens of class superiority, dismissing her authentic vitality as 'impertinence.'
</Callout>
{/* metadata:analysis-unknown:end */}

 no style, no taste, no beauty. Mrs. Hurst
...
{/* metadata:image-unknown:start */}
![Elizabeth Bennet walking through the mud.](./metadata/pride-and-prejudice/chapter-8/scene-3-var-1.png)

![Elizabeth Bennet walking through the mud.](./metadata/pride-and-prejudice/chapter-8/scene-3-var-2.png)
{/* metadata:image-unknown:end */}



“She did indeed, Louisa. I could hardly keep my countenance. Very
nonsensical to come at all! {/* metadata:quote-unknown:start */}
<Callout title="Quote" variant="note"><Callout variant="quote" title="The Scandal of Sincerity">“Why must _she_ be scampering about the country, because her sister had a cold? Her hair so untidy, so blowzy!”</Callout></Callout>
{/* metadata:quote-unknown:end */} because her sister had a cold? Her hair so untidy, so blowzy!”

“Yes, and her petticoat; I hope you saw her petticoat, six inches deep
in mud, I am absolutely certain,

{/* metadata:image-unknown:start */}
![Close-up of a muddy petticoat hem.](./metadata/pride-and-prejudice/chapter-8/scene-4-var-1.png)

![Close-up of a muddy petticoat hem.](./metadata/pride-and-prejudice/chapter-8/scene-4-var-2.png)
{/* metadata:image-unknown:end */}
...
The obsession with Elizabeth’s muddy petticoat serves as a powerful symbol of the divide between those who prioritize social decorum and those who prioritize family duty and physical action.
</Callout>
{/* metadata:analysis-unknown:end */}

 and the gown which had been let down to
...
Miss Bingley's use of the word 'independence' as an insult is central to the novel's themes. To the Bingleys, independence is 'conceited,' whereas to Elizabeth, it is a necessary part of her integrity.
</Callout>
{/* metadata:analysis-unknown:end */}
...
<Callout title="Quote" variant="note"><Callout variant="quote" title="Bingley’s Kindness">“It shows an affection for her sister that is very pleasing,” said Bingley.</Callout></Callout>
{/* metadata:quote-unknown:end */} said
Bingley.
...
“Not at all,” he replied: {/* metadata:quote-unknown:start */}
<Callout title="Quote" variant="note"><Callout variant="quote" title="Darcy’s Admiration">“Not at all,” he replied: “they were brightened by the exercise.”</Callout></Callout>
{/* metadata:quote-unknown:end */} A
...
{/* metadata:image-unknown:start */}
![The Bingley sisters laughing derisively.](./metadata/pride-and-prejudice/chapter-8/scene-5-var-1.png)

![The Bingley sisters laughing derisively.](./metadata/pride-and-prejudice/chapter-8/scene-5-var-2.png)
{/* metadata:image-unknown:end */}
...
leaving the dining-parlour,

{/* metadata:analysis-unknown:start */}
<Callout title="Analysis [5]" variant="explanation">
The 'renewal of tenderness' shown by the sisters is performed only when it is socially required, illustrating the performative nature of their empathy compared to Elizabeth’s genuine devotion.
</Callout>
{/* metadata:analysis-unknown:end */}
...
{/* metadata:image-unknown:start */}
![The party playing cards at loo.](./metadata/pride-and-prejudice/chapter-8/scene-6-var-1.png)

![The party playing cards at loo.](./metadata/pride-and-prejudice/chapter-8/scene-6-var-2.png)
{/* metadata:image-unknown:end */}

 and was immediately invited to join them; but suspecting
...
{/* metadata:quote-unknown:start */}
<Callout title="Quote" variant="note"><Callout variant="quote" title="Elizabeth’s Self-Knowledge">“I deserve neither such praise nor such censure,” cried Elizabeth; “I am _not_ a great reader, and I have pleasure in many things.”</Callout></Callout>
{/* metadata:quote-unknown:end */} cried Elizabeth; “I
...
Darcy's pride in Pemberley’s library as the 'work of many generations' underscores his deep connection to his lineage and tradition, suggesting that his character is built on a foundation more substantial than the Bingleys' new wealth.
</Callout>
{/* metadata:analysis-unknown:end */}
...
{/* metadata:quote-unknown:start */}
<Callout title="Quote" variant="note"><Callout variant="quote" title="The Internal Observer">“Elizabeth was so much caught by what passed, as to leave her very little attention for her book.”</Callout></Callout>
{/* metadata:quote-unknown:end */} as to leave her very little
...
something more substantial in the improvement of her mind

{/* metadata:analysis-unknown:start */}
<Callout title="Analysis [7]" variant="explanation">
Darcy’s addition to the list of 'accomplishments'—the improvement of the mind through reading—elevates the standard from mere social performance to intellectual substance, signaling his intellectual alignment with Elizabeth.
</Callout>
{/* metadata:analysis-unknown:end */}
...
{/* metadata:image-unknown:start */}
![Elizabeth debating accomplishments with Darcy.](./metadata/pride-and-prejudice/chapter-8/scene-7-var-1.png)

![Elizabeth debating accomplishments with Darcy.](./metadata/pride-and-prejudice/chapter-8/scene-7-var-2.png)
{/* metadata:image-unknown:end */}

 women.
{/* metadata:quote-unknown:start */}
<Callout title="Quote" variant="note"><Callout variant="quote" title="The High Bar of Accomplishment">“I am no longer surprised at your knowing _only_ six accomplished women. I rather wonder now at your knowing _any_.”</Callout></Callout>
...
to employ for captivation. {/* metadata:quote-unknown:start */}
<Callout title="Quote" variant="note"><Callout variant="quote" title="Darcy’s Moral Compass">“Undoubtedly,” replied Darcy... “Whatever bears affinity to cunning is despicable.”</Callout></Callout>
{/* metadata:quote-unknown:end */}
