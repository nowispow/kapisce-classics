...
{/* metadata:q1:start */}
<Callout title="Memorable Quote" variant="note">The discomposure of spirits which this extraordinary visit threw Elizabeth into could not be easily overcome; nor could she for many hours learn to think of it less than incessantly.</Callout>
{/* metadata:q1:end */}

{/* metadata:i2:start */}
![A young woman in contemplati

{/* metadata:i1:start */}
![An imposing aristocratic lady in elaborate morning dress confronts a composed young woman in a modest country parlor, tension evident in their opposing postures](./metadata/pride-and-prejudice/chapter-57/scene-1a.png)
...
on by a window, her expression troubled as she considers the implications of her visitor's demands](./metadata/Pride and Prejudice/LVII/scene-2a.png)

![A young woman in contemplation by a window, her expression troubled as she considers the implications of her visitor's demands](./metadata/pride-and-prejudice/chapter-57/scene-2b.png)
{/* metadata:i2:end */}
...
{/* metadata:a5:end */}
 ...
 of breaking off her supposed engagement with Mr.
Darcy. {/* metadata:q2:start */}
<Callout title="Memorable Quote" variant="note">It was a rational scheme, to be sure! but from what the report of their engagement could originate, Elizabeth was at a loss to imagine.</Callout>
{/* metadata:q2:end */}
...
{/* metadata:i6:start */}
![A scene depicting the spread of rumor between houses, showing figures in conversation across gardens and pathways](./metadata/pride-and-prejudice/chapter-57/scene-6a.png)
...
, his aunt would
address him on his weakest side. {/* metadata:q3:start */}
<Callout title="Memorable Quote" variant="note">With his notions of dignity, he would probably feel that the arguments, which to Elizabeth had appeared weak and ridiculous, contained much good sense and solid reasoning.</Callout>
{/* metadata:q3:end */}
...
constancy. {/* metadata:q4:start */}
<Callout title="Memorable Quote" variant="note">If he is satisfied with only regretting me, when he might have obtained my affections and hand, I shall soon cease to regret him at all.</Callout>
{/* metadata:q4:end */}
{/* metadata:i3:start */}
...
![An elderly gentleman and young woman seated together by a fireplace, a letter in the father's hand as he speaks with ironic amusement](./metadata/pride-and-prejudice/chapter-57/scene-3b.png)
{/* metadata:i3:end */}
...
![A young woman's face showing the sudden rush of color and confusion upon hearing unexpected news](./metadata/pride-and-prejudice/chapter-57/scene-4b.png)
{/* metadata:i4:end */}

the letter he held. It suddenly struck her that it might
...
"Memorable Quote" variant="note">This young gentleman is blessed, in a peculiar way, with everything the heart of mortal can most desire,--splendid property, noble kindred, and extensive patronage.</Callout>
{/* metadata:q5:end */} 
...
![An elderly man reading aloud from a letter while his daughter reacts with pained restraint](./metadata/pride-and-prejudice/chapter-57/scene-5b.png)
{/* metadata:i5:end */}
...
effectually to what they related? {/* metadata:q6:start */}
<Callout title="Memorable Quote" variant="note">Mr. Darcy, who never looks at any woman but to see a blemish, and who probably never looked at you in his life! It is admirable!</Callout>
{/* metadata:q6:end */}
...
not enjoy it. You are not going to be
...
feelings appear what they were not. {/* metadata:q7:start */}
<Callout title="Memorable Quote" variant="note">It was necessary to laugh when she would rather have cried. Her father had most cruelly mortified her by what he said of Mr. Darcy's indifference.</Callout>
{/* metadata:q7:end */}
...
![A young woman laughing while tears glisten in her eyes, capturing the pain of concealment](./metadata/pride-and-prejudice/chapter-57/scene-7b.png)
{/* metadata:i7:end */}
