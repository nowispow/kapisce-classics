...
before Tuesday; and in her postscript it was added, that if Mr. {/* metadata:quote_001:start */}
...
{/* metadata:quote_001:end */} Against staying longer, however, Elizabeth was positively
resolved--nor did she much expect it would be asked; and fearful, on the
contrary, of being considered as {/* metadata:quote_002:start */}
<Callout title="Memorable Quote" variant="note">Against staying longer, however, Elizabeth was positively resolved--nor did she much expect it would be asked; and fearful, on the contrary, of being considered as intruding themselves needlessly long, she urged Jane to borrow Mr. Bingley's carriage immediately.</Callout>
...
![Elizabeth Bennet writing a letter by morning light, with Jane seated nearby looking concerned, in an elegant Netherfield morning room](./metadata/Pride and Prejudice/XII/elizabeth-writing-carriage-request.png)

![Elizabeth Bennet writing a letter by morning light, with Jane seated nearby looking concerned, in an elegant Netherfield morning room](./metadata/Pride and Prejudice/XII/writing-letter-closeup.png)
...
Jane; and till the morrow their going was deferred. {/* metadata:quote_003:start */}
...
![Caroline Bingley with a false smile expressing concern while internally scheming, in a lavish drawing room](./metadata/Pride and Prejudice/XII/miss-bingley-false-concern.png)

![Caroline Bingley with a false smile expressing concern while internally scheming, in a lavish drawing room](./metadata/Pride and Prejudice/XII/miss-bingley-full-length.png)
...
![Mr. Bingley pleading with Jane Bennet to stay longer, genuine concern on his face, in a library or sitting room](./metadata/Pride and Prejudice/XII/bingley-pleading-with-jane.png)

![Mr. Bingley pleading with Jane Bennet to stay longer, genuine concern on his face, in a library or sitting room](./metadata/Pride and Prejudice/XII/bingley-sincere-expression.png)
...
Netherfield long enough. {/* metadata:quote_004:start */}
<Callout title="Memorable Quote" variant="note">To Mr. Darcy it was welcome intelligence: Elizabeth had been at Netherfield long enough. She attracted him more than he liked; and Miss Bingley was uncivil to her and more teasing than usual to himself.</Callout>
{/* metadata:quote_004:end */} and Miss
...
conscientiously to his book, and {/* metadata:quote_005:start */}
...
![Mr. Darcy sternly reading a large book, deliberately avoiding looking at Elizabeth who sits nearby, in a drawing room](./metadata/Pride and Prejudice/XII/darcy-avoiding-elizabeth.png)

![Mr. Darcy sternly reading a large book, deliberately avoiding looking at Elizabeth who sits nearby, in a drawing room](./metadata/Pride and Prejudice/XII/darcy-reading-aloof.png)
...
tenderly, {/* metadata:quote_006:start */}
...
{/* metadata:quote_006:end */} Elizabeth took leave of
the whole party in the liveliest spirits.

{/* metadata:image_005:start */}
![Elizabeth and Jane leaving Netherfield with cheerful composure while Miss Bingley shakes hands coolly, the carriage waiting outside](./metadata/Pride and Prejudice/XII/departure-netherfield-scene.png)

![Elizabeth and Jane leaving Netherfield with cheerful composure while Miss Bingley shakes hands coolly, the carriage waiting outside](./metadata/Pride and Prejudice/XII/into-the-carriage.png)
...
![The Bennet family gathered in the drawing room at Longbourn, with Mrs. Bennet expressing displeasure and Mr. Bennet showing quiet satisfaction](./metadata/Pride and Prejudice/XII/longbourn-family-gathered.png)

![The Bennet family gathered in the drawing room at Longbourn, with Mrs. Bennet expressing displeasure and Mr. Bennet showing quiet satisfaction](./metadata/Pride and Prejudice/XII/mr-bennet-quiet-pleasure.png)
...
{/* metadata:quote_007:end */} Catherine and Lydia had information
...
![Kitty and Lydia Bennet excitedly sharing news about officers and military gossip in a provincial sitting room](./metadata/Pride and Prejudice/XII/kitty-lydia-gossiping.png)

![Kitty and Lydia Bennet excitedly sharing news about officers and military gossip in a provincial sitting room](./metadata/Pride and Prejudice/XII/young-bennets-excitement.png)
