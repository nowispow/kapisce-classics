...
![An exuberant mother celebrates her daughter's engagement with dramatic gestures and overwhelming joy](./metadata/Pride and Prejudice/Chapter LV/scene-6a.png)

![An exuberant mother celebrates her daughter's engagement with dramatic gestures and overwhelming joy](./metadata/Pride and Prejudice/Chapter LV/scene-6b.png)
{/* metadata:image_006:end */}

 Bennet invited him to dine with them; but, with many
...
<Callout title="Memorable Quote" variant="note">Never mind Miss Lizzy's hair.</Callout>
...
![A distraught mother in a dressing gown rushes into her daughter's chamber, gesturing urgently while a young woman sits at her vanity](./metadata/Pride and Prejudice/Chapter LV/scene-1a.png)

![A distraught mother in a dressing gown rushes into her daughter's chamber, gesturing urgently while a young woman sits at her vanity](./metadata/Pride and Prejudice/Chapter LV/scene-1b.png)
...
<Callout title="Memorable Quote" variant="note">Oh! hang Kitty! what has she to do with it?</Callout>
{/* metadata:quote_002:end */} Come, be quick, be quick!
...
returned within the stated tim

{/* metadata:image_002:start */}
![A young couple stands together by a fireplace in earnest conversation, turning away in surprise as the door opens](./metadata/Pride and Prejudice/Chapter LV/scene-2a.png)

![A young couple stands together by a fireplace in earnest conversation, turning away in surprise as the door opens](./metadata/Pride and Prejudice/Chapter LV/scene-2b.png)
{/* metadata:image_002:end */}

e. Seriously, however, she felt tolerably
...
{/* metadata:analysis_003:end */}
 ...
 Bennet’s invention was again at work to get
...
emotion, that {/* metadata:quote_004:start */}
<Callout title="Memorable Quote" variant="note">she was the happiest creature in the world.</Callout>
{/* metadata:quote_004:end */}

{/* metadata:image_003:start */}
![Two sisters embrace in a drawing room, one overcome with emotion, the o
...
ther expressing sincere happiness](./metadata/Pride and Prejudice/Chapter LV/scene-3a.png)

![Two sisters embrace in a drawing room, one overcome with emotion, the other expressing sincere happiness](./metadata/Pride and Prejudice/Chapter LV/scene-3b.png)
...
![A cheerful gentleman in Regency dress clasps hands with a young lady, expressing happiness and affectionate regard](./metadata/Pride and Prejudice/Chapter LV/scene-4a.png)

![A cheerful gentleman in Regency dress clasps hands with a young lady, expressing happiness and affectionate regard](./metadata/Pride and Prejudice/Chapter LV/scene-4b.png)
{/* metadata:image_004:end */}

esh source of happiness to Jane. But she would not
allow herself to stay with her sister, or say half that remained to be
said, for the present.

“I must go instantly to my mother,” she cried. {/* metadata:quote_003:start */}
<Callout title="Memorable Quote" variant="note">I would not on any account trifle with her affectionate solicitude, or allow her to hear it from anyone but myself.</Callout>
{/* metadata:quote_003:end */} He is gone to my father already. Oh, Lizzy, to
know that what I have to relate will give s
...
with which an affair was finally settled, 

{/* metadata:image_005:start */}
![An affectionate father embraces his daughter after giving his blessing for her engagement](./metadata/Pride and Prejudice/Chapter LV/scene-5a.png)

![An affectionate father embraces his daughter after giving his blessing for her engagement](./metadata/Pride and Prejudice/Chapter LV/scene-5b.png)
{/* metadata:image_005:end */}

that had given them so many
previous months of suspense and vexation.

“And this,” said she, “is the end of all his friend’s anxious
circumspection! of all his sister’s falsehood and contrivance! {/* metadata:quote_005:start */}
<Callout title="Memorable Quote" variant="note">And this is the end of all his friend's anxious circumspection! of all his sister's falsehood and contrivance! the happiest, wisest, and most reasonable end!</Callout>
...
doing very well together. Your tempers are by no means unlike. {/* metadata:quote_006:start */}
<Callout title="Memorable Quote" variant="note">You are each of you so complying, that nothing will ever be resolved on; so easy, that every servant will cheat you; and so generous, that you will always exceed your income.</Callout>
...
Elizabeth had now but little time for conversation with her sister; fo
...
![Women exchanging secrets and gossip in a provincial setting, representing the spread of news through the neighborhood](./metadata/Pride and Prejudice/Chapter LV/scene-7a.png)

![Women exchanging secrets and gossip in a provincial setting, representing the spread of news through the neighborhood](./metadata/Pride and Prejudice/Chapter LV/scene-7b.png)
{/* metadata:image_007:end */}

d himself to Elizabeth for the pleasure of talking of her; and
...
<Callout title="Memorable Quote" variant="note">If I could but see you as happy! If there were but such another man for you!</Callout>
