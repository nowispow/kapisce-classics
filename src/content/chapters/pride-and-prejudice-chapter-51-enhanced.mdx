...
<Callout title="Memorable Quote" variant="note">Their sister's wedding-day arrived; and Jane and Elizabeth felt for her probably more than she felt for herself.</Callo
...
![Jane and Elizabeth Bennet waiting anxiously for the carriage bringing Lydia home](./metadata/Pride and Prejudice/Chapter LI/scene-1a.png)

![Jane and Elizabeth Bennet waiting anxiously for the carriage bringing Lydia home](./metadata/Pride and Prejudice/Chapter LI/scene-1b.png)
{/* metadata:image-001:end */}

ut>
{/* metadata:quote-001:end */} The carriage was sent to meet
...
<Callout title="Memorable Quote" variant="note">Jane more especially, who gave Lydia the feelings which would have attended her

{/* metadata:image-006:start */}
![Lydia accidentally revealing Mr. Darcy's presence at her wedding](./metadata/Pride and Prejudice/Chapter LI/scene-6a.png)

![Lydia accidentally revealing Mr. Darcy's presence at her wedding](./metadata/Pride and Prejudice/Chapter LI/scene-6b.png)
{/* metadata:image-006:end */}

self, had she been the culprit, and was wretched in the thought of what her sister must endure.</Callout>
...
![Mrs. Bennet embracing Lydia with joy while Mr. Bennet looks on gravely](./metadata/Pride and Prejudice/Chapter LI/scene-2a.png)

![Mrs. Bennet embracing Lydia with joy while Mr. Bennet looks on gravely](./metadata/Pride and Prejudice/Chapter LI/scene-2b.png)
{/* metadata:image-002:end */}

e room. Her mother stepped forwards, embraced her, and
...
Elizabeth was disgusted, and even Miss Bennet was shocked. {/* metadata:quote-003:start */}
<Callout title="Memorable Quote" variant="note">Lydia w
...
as Lydia still; untamed, unabashed, wild, noisy, and fearless.</Callout>
{/* metadata:quote-003:end */}

{/* metadata:image-003:start */}
![Lydia speaking loudly and laughing in the breakfast room while her sisters look uncomfortable](./metadata/Pride and Prejudice/Chapter LI/scene-3a.png)

![Lydia speaking loudly and laughing in the breakfast room while her sisters look uncomfortable](./metadata/Pride and Prejudice/Chapter LI/scene-3b.png)
...
impudence of an impudent man. {/* metadata:quote-004:start */}
<Callout title="Memorable Quote" variant="note">She blushed, and Jane blushed; but the cheeks of the two who caused their confusion suffered no variation of colour.</Callout>
...
![Lydia showing off her wedding ring from a carriage window](./metadata/Pride and Prejudice/Chapter LI/scene-4a.png)

![Lydia showing off her wedding ring from a carriage window](./metadata/Pride and Prejudice/Chapter LI/scene-4b.png)
...
enough happened in the time. Good gracious! when I wen
...
expressively at Lydia; but she, 

{/* metadata:image-005:start */}
![Lydia insisting on taking precedence as a married woman](./metadata/Pride and Prejudice/Chapter LI/scene-5a.png)

![Lydia insisting on taking precedence as a married woman](./metadata/Pride and Prejudice/Chapter LI/scene-5b.png)
{/* metadata:image-005:end */}

who never heard nor saw anything of
...
window frame, so that he might see the ring,
...
parties at home. These parties were acceptable to
...
{/* metadata:analysis-007:end */}
 ...
 such suspense; and hastily seizing a sheet of paper,
...
<Callout title="Memorable Quote" variant="note">"and, my dear aunt, if you do not tell me in an honourable manner, I shall certainly be reduced to tricks and stratagems to find it out."</Callout>
{/* metadata:quote-007:end */}

{/* metadata:image-007:start */}
![Elizabeth writing urgently to her aunt for information about Mr. Darcy](./metadata/Pride and Prejudice/Chapter LI/scene-7a.png)

![Elizabeth writing urgently to her aunt for information about Mr. Darcy](./metadata/Pride and Prejudice/Chapter LI/scene-7b.png)
