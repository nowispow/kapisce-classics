...
description: "Follow the story in Chapter 46 of Jane Austen's Pride And Prejudice."
date: 2026-02-16
authors: ['jane-austen']
...
![Mr. and Mrs. Gardiner walking arm in arm through a country lane, leaving Elizabeth behind at the inn](./metadata/pride-and-prejudice/chapter-46/scene-2a.png)

![Mr. and Mrs. Gardiner walking arm in arm through a country lane, leaving Elizabeth behind at the inn](./metadata/pride-and-prejudice/chapter-46/scene-2b.png)
{/* metadata:image_002:end */}

 The one mis-sent must be first attended to; it had been
...
<Callout title="Memorable Quote" variant="note">Since writing the above, dearest Lizzy, something has occurred of a most unexpected and serious nature; but I am afraid of alarming you--be assured that we are all well.</Callout>
{/* metadata:quote_001:end */} What I have to say relates to poor Lydia.
{/* metadata:quote_002:start */}
<Callout title="Memorable Quote" variant="note">An express came at twelve last night, just as we were all gone to bed, from Colonel Forster, to inform us that she was gone off to Scotland with one of his officers; to own the truth, with Wickham!</Callout>
{/* metadata:quote_002:end */} Imagine our
...
Without allowing herself time fo

{/* metadata:analysis_001:start */}
<Callout title="Analysis" variant="explanation">
This chapter marks the catastrophic turning point of the novel, where Elizabeth's personal hopes are shattered by Lydia's elopement with Wickham. The dramatic irony is profound—Elizabeth, who has recently discovered her growing affection for Darcy, now faces the ruin of any possible future with him due to her sister's disgrace. Austen's mastery of pacing is evident as the revelation unfolds through two increasingly alarming letters from Jane, the first holding out hope of marriage and the second dashing it entirely, building suspense and horror with each paragraph.
</Callout>
{/* metadata:analysis_001:end */}

{/* metadata:image_001:start */}
![Elizabeth Bennet seated in a drawing room, holding opened letters with an expression of growing alarm and distress](./metadata/pride-and-prejudice/chapter-46/scene-1a.png)

![Elizabeth Bennet seated in a drawing room, holding opened letters with an expression of growing alarm and distress](./metadata/pride-and-prejudice/chapter-46/scene-1b.png)
{/* metadata:image_001:end */}

r consideration, and scarcely knowing
...
![Mr. and Mrs. Gardiner hurrying back to the inn, faces showing concern for their niece's sudden illness](./metadata/pride-and-prejudice/chapter-46/scene-6a.png)

![Mr. and Mrs. Gardiner hurrying back to the inn, faces showing concern for their niece's sudden illness](./metadata/pride-and-prejudice/chapter-46/scene-6b.png)
{/* metadata:image_006:end */}

ield, but without any success,--no such people had been seen to
...
<Callout title="Analysis" variant="explanation">
The letter device serves multiple narrative functions in this chapter. Jane's first letter expresses hope that marriage might still occur, while the second dashes this possibility entirely, noting that Colonel Forster himself shook his head when Jane expressed her hopes. This progression mirrors Elizabeth's own emotional journey—from shock to desperate hope, then to devastating resignation. Jane's characteristic gentleness leads her to write 'I cannot think so ill of him,' a contrast that throws Elizabeth's clear-eyed recognition of Wickham's villainy into sharp relief.
</Callout>
{/* metadata:analysis_002:end */}

ely, can I suppose her so lost to everything?
...
<Callout title="Memorable Quote" variant="note">Oh! where, where is my uncle? cried Elizabeth, darting from her seat as she finished the letter, in eagerness to follow him, without losing a moment of the time so 

{/* metadata:image_003:start */}
![Mr. Darcy entering a room where Elizabeth stands in visible distress, pale and impetuous in manner](./metadata/pride-and-prejudice/chapter-46/scene-3a.png)

![Mr. Darcy entering a room where Elizabeth stands in visible distress, pale and impetuous in manner](./metadata/pride-and-prejudice/chapter-46/scene-3b.png)
{/* metadata:image_003:end */}

precious.</Callout>
{/* metadata:quote_003:end */} but as she reached the door, it was
...
again. {/* metadata:quote_004:start */}
<Callout title="Memorable Quote" variant="note">I have just had a letter from Jane, with such dreadful news. It cannot be concealed from anyone. My youngest sister has left all her friends--has eloped; has thrown herself into the power of--of Mr. Wickham.</Callout>
{/* metadata:quote_004:end */} They are gone off together from Brighton. _You_ know him too
...
<Callout title="Memorable Quote" variant="note">When I consider, she added, in a yet more agitated voice, that I might have prevented it! I who knew what he was.</Callout>
{/* metadata:quote_005:end */}

{/* metadata:analysis_003:start */}
<Callout title="Analysis" variant="explanation">
Elizabeth's self-recrimination is crucial to understanding her character development. Her acknowledgment that she might have prevented the catastrophe—'I who knew what he was'—reveals her sense of responsibility and moral accountability. This moment of honest self-examination shows Elizabeth at her most vulnerable, recognizing both her power and her failure to use it. Had she disclosed Wickham's true character to her family, the tragedy might have been averted, and the weight of that knowledge is almost unbearable t

{/* metadata:analysis_004:start */}
<Callout title="Analysis" variant="explanation">
The timing of Darcy's arrival creates maximum dramatic tension. His appearance at the exact moment of Elizabeth's distress creates an opportunity for intimacy between them that is immediately complicated by the terrible news she must share. Their exchange demonstrates both Darcy's genuine concern for Elizabeth and the social protocols that constrain their interaction. He walks up and down the room in earnest meditation, his brow contracted and his air gloomy, and Elizabeth instantly understands that his self-conquest signals the end of any hope she had harboured.
</Callout>
{/* metadata:analysis_004:end */}

{/* metadata:image_005:start */}
![Mr. Darcy pacing the room with contracted brow and gloomy air, deep in thought and concern](./metadata/pride-and-prejudice/chapter-46/scene-5a.png)

![Mr. Darcy pacing the room with contracted brow and gloomy air, deep in thought and concern](./metadata/pride-and-prejudice/chapter-46/scene-5b.png)
...
<Callout title="Analysis" variant="explanation">
Elizabeth's acute awareness that 'everything must sink under such a proof of family weakness' reflects her understanding of class and social mobility in Regency England. She recognizes that her family's disgrace destroys any hope she might have had with Darcy, regardless of his personal feelings. The cruelest irony is that this moment of social reckoning also clarifies her own desires: 'never had she so honestly felt that she could have loved him, as now, when all love must be vain.'
</Callout>
...
“When _my_ eyes were opened to his real chara

{/* metadata:image_004:start */}
![Elizabeth weeping, her face covered partially by a handkerchief, overcome with grief and shame](./metadata/pride-and-prejudice/chapter-46/scene-4a.png)

![Elizabeth weeping, her face covered partially by a handkerchief, overcome with grief and shame](./metadata/pride-and-prejudice/chapter-46/scene-4b.png)
{/* metadata:image_004:end */}

cter, oh! had I known what
...
gloomy. Elizabeth soon observed, and instantly understood it. {/* metadata:quote_006:start */}
<Callout title="Memorable Quote" variant="note">Her power was sinking; everything must sink under such a proof of family weakness, such an assurance of the deepest disgrace.</Callout>
{/* metadata:quote_006:end */} She could neither
...
<Callout title="Memorable Quote" variant="note">Would to Heaven that anything could be either said or done on my part, that might offer consolation to such distress!</Callout>
{/* metadata:quote_007:end */} But I will not torment
...
less interesting mode

{/* metadata:analysis_006:start */}
<Callout title="Analysis" variant="explanation">
The chapter illustrates Austen's critique of parental negligence with pointed precision. Elizabeth's reflection that 'the mischief of neglect and mistaken indulgence towards such a girl' has led to this catastrophe serves as both personal observation and broader social commentary. Mrs. Bennet's foolish encouragement of Lydia's flirtations and Mr. Bennet's failure to discipline his youngest daughter are shown to have disastrous consequences that fall upon the entire family. The narrator notes that Lydia's affections had been 'continually fluctuating, but never without an object,' a damning portrait of a girl shaped by indulgence rather than principle.
</Callout>
{/* metadata:analysis_006:end */}

 of attachment. Be that as it may, she saw him go
...
deeply affected. Not Lydia only, but all were concerned in it; and af

{/* metadata:analysis_007:start */}
<Callout title="Analysis" variant="explanation">
The final paragraphs demonstrate Elizabeth's resilience and practical nature despite her devastation. Even in her wretched state, she attends to the necessary arrangements for departure, writing notes 'with false excuses for their sudden departure' to maintain appearances before the world. This attention to social propriety, even amid crisis, reveals the inescapable nature of societal expectations in Regency England. The chapter closes with Elizabeth seated in the carriage and on the road to Longbourn, carrying her private anguish forward into an uncertain future.
</Callout>
{/* metadata:analysis_007:end */}

{/* metadata:image_007:start */}
![Elizabeth seated in a carriage departing, her face showing the misery of the morning despite the hasty journey preparations](./metadata/pride-and-prejudice/chapter-46/scene-7a.png)

![Elizabeth seated in a carriage departing, her face showing the misery of the morning despite the hasty journey preparations](./metadata/pride-and-prejudice/chapter-46/scene-7b.png)
