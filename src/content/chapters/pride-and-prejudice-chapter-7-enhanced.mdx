...
{/* metadata:pp-ch7-image-1:start */}
![Renaissance oil painting of a modest English estate at Longbourn](./metadata/pride-and-prejudice/chapter-7/scene-1a.png)

![Renaissance oil painting of a modest English estate at Longbourn](./metadata/pride-and-prejudice/chapter-7/scene-1b.png)
{/* metadata:pp-ch7-image-1:end */}



{/* metadata:pp-ch7-analysis-1:start */}
<Callout title="Analysis 1" variant="explanation">
The financial insecurity of the Bennet family is established through the concept of 'entailment.' Because Mr. Bennet has no sons, his estate will pass to a distant male relative, leaving his daughters dependent on their small maternal inheritance or marriage. This structural vulnerability drives the urgency of Mrs. Bennet's matchmaking.
</Callout>
{/* metadata:pp-ch7-analysis-1:end */}
...
{/* metadata:pp-ch7-image-2:start */}
![Renaissance oil painting of Catherine and Lydia walking to Meryton](./metadata/pride-and-prejudice/chapter-7/scene-2a.png)

![Renaissance oil painting of Catherine and Lydia walking to Meryton](./metadata/pride-and-prejudice/chapter-7/scene-2b.png)
{/* metadata:pp-ch7-image-2:end */}
...
{/* metadata:pp-ch7-analysis-2:start */}
<Callout title="Analysis 2" variant="explanation">
The arrival of the militia regiment introduces a new layer of social distraction. For the younger Bennet sisters, Catherine and Lydia, the officers represent excitement and romance, contrasting with the more intellectual or pragmatic concerns of their older sisters.
</Callout>
{/* metadata:pp-ch7-analysis-2:end */}
...
“{/* metadata:pp-ch7-quote-1:start */}
<Callout title="Mr. Bennet's Judgment" variant="note">“From all that I can collect by your manner of talking, you must be two of the silliest girls in the country. I have suspected it some time, but I am now convinced.”</Callout>
{/* metadata:pp-ch7-quote-1:end */}

{/* metadata:pp-ch7-image-3:start */}
![Renaissance oil painting of Mr. Bennet observing his daughters](./metadata/pride-and-prejudice/chapter-7/scene-3a.png)

![Renaissance oil painting of Mr. Bennet observing his daughters](./metadata/pride-and-prejudice/chapter-7/scene-3b.png)
{/* metadata:pp-ch7-image-3:end */}



{/* metadata:pp-ch7-analysis-3:start */}
<Callout title="Analysis 3" variant="explanation">
Mr. Bennet's dry humor and critical view of his younger daughters highlight the intellectual divide within the family. His blunt assessment of them as 'silly' reflects his detached and somewhat cynical parental style.
</Callout>
{/* metadata:pp-ch7-analysis-3:end */}
...
“{/* metadata:pp-ch7-quote-2:start */}
<Callout title="Paternal Honesty" variant="note">“If my children are silly, I must hope to be always sensible of it.”</Callout>
{/* metadata:pp-ch7-quote-2:end */}.”
...
“{/* metadata:pp-ch7-quote-3:start */}
<Callout title="Mrs. Bennet's Scheme" variant="note">“No, my dear, you had better go on horseback, because it seems likely to rain; and then you must stay all night.”</Callout>
{/* metadata:pp-ch7-quote-3:end */}

{/* metadata:pp-ch7-analysis-4:start */}
<Callout title="Analysis 4" variant="explanation">
Mrs. Bennet's scheme to send Jane to Netherfield on horseback, knowing it would rain, demonstrates her manipulative approach to matchmaking. She prioritizes the opportunity for Jane to stay overnight near Mr. Bingley over her daughter's physical health.
</Callout>
{/* metadata:pp-ch7-analysis-4:end */}
...
{/* metadata:pp-ch7-image-4:start */}
![Renaissance oil painting of Jane Bennet on horseback in the rain](./metadata/pride-and-prejudice/chapter-7/scene-4a.png)

![Renaissance oil painting of Jane Bennet on horseback in the rain](./metadata/pride-and-prejudice/chapter-7/scene-4b.png)
{/* metadata:pp-ch7-image-4:end */}
...
{/* metadata:pp-ch7-analysis-5:start */}
<Callout title="Analysis 5" variant="explanation">
Jane's illness is the direct result of her mother's calculation. The irony of the 'felicity of her contrivance' being Jane's suffering illustrates the moral compromise Mrs. Bennet is willing to make for social advancement.
</Callout>
{/* metadata:pp-ch7-analysis-5:end */}
...
aloud, “{/* metadata:pp-ch7-quote-4:start */}
<Callout title="Sarcastic Consolation" variant="note">“if your daughter should have a dangerous fit of illness--if she should die--it would be a comfort to know that it was all in pursuit of Mr. Bingley, and under your orders.”</Callout>
{/* metadata:pp-ch7-quote-4:end */}.”
...
{/* metadata:pp-ch7-image-5:start */}
![Renaissance oil painting of Elizabeth Bennet walking through fields](./metadata/pride-and-prejudice/chapter-7/scene-5a.png)

![Renaissance oil painting of Elizabeth Bennet walking through fields](./metadata/pride-and-prejudice/chapter-7/scene-5b.png)
{/* metadata:pp-ch7-image-5:end */}

.

“{/* metadata:pp-ch7-quote-5:start */}
<Callout title="Social Propriety" variant="note">“How can you be so silly,” cried her mother, “as to think of such a thing, in all this dirt! You will not be fit to be seen when you get there.”</Callout>
{/* metadata:pp-ch7-quote-5:end */}.”

“{/* metadata:pp-ch7-quote-6:start */}
<Callout title="Elizabeth's Priority" variant="note">“I shall be very fit to see Jane--which is all I want.”</Callout>
{/* metadata:pp-ch7-quote-6:end */}.”
...
“I admire the activity of your benevolence,” observed Mary, “but {/* metadata:pp-ch7-quote-7:start */}
<Callout title="Mary's Moralizing" variant="note">“every impulse of feeling should be guided by reason; and, in my opinion, exertion should always be in proportion to what is required.”</Callout>
{/* metadata:pp-ch7-quote-7:end */}.”
...
{/* metadata:pp-ch7-image-6:start */}
![Renaissance oil painting of Elizabeth arriving at Netherfield](./metadata/pride-and-prejudice/chapter-7/scene-6a.png)

![Renaissance oil painting of Elizabeth arriving at Netherfield](./metadata/pride-and-prejudice/chapter-7/scene-6b.png)
{/* metadata:pp-ch7-image-6:end */}



{/* metadata:pp-ch7-analysis-6:start */}
<Callout title="Analysis 6" variant="explanation">
Elizabeth's decision to walk three miles through the mud to see her sister showcases her independence and deep sisterly affection. It also sets up a class-based conflict, as her 'dirty stockings' become a point of silent contempt for the Bingley sisters.
</Callout>
{/* metadata:pp-ch7-analysis-6:end */}
...
{/* metadata:pp-ch7-analysis-7:start */}
<Callout title="Analysis 7" variant="explanation">
Mr. Darcy's internal conflict is further developed here. While he finds Elizabeth's appearance 'incredible' and socially improper, he is simultaneously drawn to the 'brilliancy' her exercise has given her. This 'division' marks a key step in his growing attraction.
</Callout>
{/* metadata:pp-ch7-analysis-7:end */}
...
{/* metadata:pp-ch7-image-7:start */}
![Renaissance oil painting of Jane and Elizabeth at Netherfield](./metadata/pride-and-prejudice/chapter-7/scene-7a.png)

![Renaissance oil painting of Jane and Elizabeth at Netherfield](./metadata/pride-and-prejudice/chapter-7/scene-7b.png)
{/* metadata:pp-ch7-image-7:end */}
