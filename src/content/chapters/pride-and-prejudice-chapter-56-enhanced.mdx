...
lawn. {/* metadata:quote_01_arrival:start */}
<Callout title="Memorable Quote" variant="note">It was too early in the morning for visitors; and besides, the equipage did not answer to that of any of their neighbours.</Callout>
{/* metadata:quote_01_arrival:end */} The horses
...
shrubbery. They both set off; and the conjectures of the remaining thre
...
![A grand carriage with four horses approaches a modest country estate in the early morning light](./metadata/pride-and-prejudice/chapter-56/scene-1b.png)
...
<Callout title="Memorable Quote" variant="note">She entered the room with an air more than usually ungracious, made no other reply to Elizabeth's salutation than a slight inclination of the head, and sat down without saying a word.</Callout>
{/* metadata:quote_02_dismissal:end */}

{/* metadata:ip_02_confrontation:start */}
![Lady Catherine and Elizabeth in tense exchange within the modest Bennet parlor](./metadata/pride-and-prejudice/chapter-56/scene-2a.png)
...
![Elizabeth and Lady Catherine walking along a gravel path toward the wilderness](./metadata/pride-and-prejudice/chapter-56/scene-3a.png)
...
declined eating anything; and then, rising up, sa
...
journey hither. {/* metadata:quote_03_accusation:start */}
<Callout title="Memorable Quote" variant="note">Your own heart, your own conscience, must tell you why I come.</Callout>
...
![Lady Catherine confronting Elizabeth with accusations about Mr. Darcy](./metadata/pride-and-prejudice/chapter-56/scene-4a.png)
...
{/* metadata:ip_04_accusation:end */}
 ...
 I am not to be trifled with. But however insincere _you_ may
choose to be, you shall not find _me_ so. {/* metadata:quote_04_frankness:start */}
<Callout title="Memorable Quote" variant="note">My character has ever been celebrated for its sincerity and frankness; and in a cause of such moment as this, I shall certainly not depart from it.</Callout>
{/* metadata:quote_04_frankness:end */} A report of a most
...
onishment and disdain, “I wonder you took the trouble of coming
...
character, if you think I can be worked on by such per
...
what are you thinking? {/* metadata:quote_06_pollution:start */}
<Callout title="Memorable Quote" variant="note">Are the shades of Pemberley to be thus polluted?</Callout>
...
Unfeeling, selfish girl! Do you not cons
...
ider that a connection with you
...
“I have said no such thing. {/* metadata:quote_05_claims:start */}
<Callout title="Memorable Quote" variant="note">I am only resolved to act in that manner, which will, in my own opinion, constitute my happiness, without reference to you, or to any person so wholly unconnected with me.</Callout>
...
![Elizabeth firmly refusing Lady Catheri

{/* metadata:ip_06_farewell:start */}
![Lady Catherine departing in her carriage without taking leave](./metadata/pride-and-prejudice/chapter-56/scene-6a.png)
...
ne's demands in the garden setting](./metadata/pride-and-prejudice/LVI/scene-5b.png)
...
![Elizabeth's mother eagerly meeting her in the hallway seeking gossip](./metadata/pride-and-prejudice/chapter-56/scene-7b.png)
{/* metadata:ip_07_mother:end */}

marrying me, it would not give me one moment’s
...
<Callout title="Memorable Quote" variant="note">I take no leave of you, Miss Bennet. I send no compliments to your mother. You deserve no such attention. I am most seriously displeased.</Callout>
