...
{/* metadata:2:end */}
My father, however, is partial to Mr. Wickham. In short, my dear aunt, I
...
<Callout title="Memorable Quote" variant="note">how can I promise to be wiser than so many of my fellow-creatures, if I am tempted, or how am I even to know that it would be wiser to resist?</Callout>
All that I can promise you, therefore, is
...
![a young woman with intelligent expression and slight smile, sitting in contemplation](/static/illustrations/pride-and-prejudice/chapter-26/scene-2b.png)
...
{/* metadata:1:start */}
![an interior scene with two women in period dress engaged in intimate conversation, one older and concerned, the other younger and thoughtful](/static/illustrations/pride-and-prejudice/chapter-26/scene-1b.png)
{/* metadata:1:end */}
...
{/* metadata:3:start */}
![two women descending a staircase together, one departing with mixed emotions](/static/illustrations/pride-and-prejudice/chapter-26/scene-3b.png)
{/* metadata:3:end */}
...
{/* metadata:4:start */}
![a bride and groom departing from a church, surrounded by wedding guests](/static/illustrations/pride-and-prejudice/chapter-26/scene-4b.png)
{/* metadata:4:end */}
...
{/* metadata:4:end */}
Charlotte’s first letters were received with a good deal of eagerness: there could not but be
...
{/* metadata:6:start */}
![two women in a formal drawing room, one visibly uncomfortable and making excuses to leave](/static/illustrations/pride-and-prejudice/chapter-26/scene-6b.png)
{/* metadata:6:end */}
...
{/* metadata:5:start */}
![a young woman reading a letter with visible sadness, seated in a London drawing room](/static/illustrations/pride-and-prejudice/chapter-26/scene-5b.png)
{/* metadata:5:end */}
...
even wish for any renewal of his attentions.
{/* metadata:6:start */}
...
{/* metadata:6:end */}
as, by Wickham’s account, she would make him abundantly
...
{/* metadata:7:start */}
![a young woman in quiet contemplation, her expression showing philosophical acceptance](/static/illustrations/pride-and-prejudice/chapter-26/scene-7b.png)
{/* metadata:7:end */}
...
his defection much more to heart than I do. They are young in the ways of the world,
and not yet open to the mortifying conviction that
