...
![Elizabeth Bennet playfully questioning Mr. Darcy about the origins of his affections](./metadata/pride-and-prejudice/chapter-60/scene-1b.png)
...
laid the foundation. It is too long ago. {/* metadata:quote_001:start */}
<Callout title="Memorable Quote" variant="note">I was in the middle before I knew that I had begun.</Callout>
...
![Mr. Darcy explaining that he was in love before he knew it had begun](./metadata/pride-and-prejudice/chapter-60/scene-2a.png)
...
reasonable. {/* metadata:quote_003:start */}
<Callout title="Memorable Quote" variant="note">To be sure you know no actual good of me—but nobody thinks of that when they fall in love.</Callout>
...
by all means. My good qualities are 
...
under your protection, and you are
...
![Mr. Darcy composing his letter announcing his engagement to Lady Catherine](./metadata/pride-and-prejudice/chapter-60/scene-3b.png)
...
<Callout title="Memorable Quote" variant="note">Lady Catherine has been of infinite use, which ought to make her happy, for she loves to be of use.</Callout>
...
{/* metadata:analysis_004:end */}
 ...
 But tell me, what did you come down to
Netherfield for? Was it merely to ride to Longbo
...
“I am more likely to want time than courage, Elizabeth. But it ou

{/* metadata:image_006:start */}
![Miss Georgiana Darcy writing with overflowing happiness about gaining a sister](./metadata/pride-and-prejudice/chapter-60/scene-6a.png)
...
ponies is delightful. We will go round the park every day. {/* metadata:quote_005:start */}
...
![Elizabeth joyfully writing to her aunt to announce her engagement](./metadata/pride-and-prejudice/chapter-60/scene-4a.png)
...
only smiles, I laugh. Mr. Darcy sends you all the
...
![Elizabeth imagining the comfort and elegance of her future home at Pemberley](./metadata/pride-and-prejudice/chapter-60/scene-7b.png)
...
for his last.
     ...
     soon be the wife of Mr. Darcy. {/* metadata:quote_006:start */}
...
![Mr. Bennet's comedic letter of congratulations to Mr. Collins](./metadata/pride-and-prejudice/chapter-60/scene-5b.png)
...
converse without mortification; and {/* metadata:quote_007:start */}
<Callout title="Memorable Quote" variant="note">though the uncomfortable feelings arising from all this took from the season of courtship much of its pleasure, it added to the hope of the future</Callout>
{/* metadata:quote_007:end */} and she looked forward
